            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Select value={dataType} onValueChange={setDataType}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="training-data">Training Data Leakage</SelectItem>
                  <SelectItem value="pii-extraction">PII Extraction</SelectItem>
                  <SelectItem value="api-keys">API Key Exposure</SelectItem>
                  <SelectItem value="context-data">Context Data Leakage</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">88.2%</p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">8.9%</p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">2.9%</p>
                      </div>
