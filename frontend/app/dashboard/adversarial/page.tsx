    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Run sophisticated adversarial attacks to test your LLM's robustness against edge cases and malicious inputs.
        </p>
      </div>
        ...
        <>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Comprehensive adversarial attack assessment results</CardDescription>
                </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold">934</p>
                        <p className="text-xs text-muted-foreground mt-1">85.8%</p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">10.3%</p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">3.9%</p>
                      </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Test performance across different attack categories</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {[
                { name: "Semantic", passed: 178, total: 200, color: "bg-blue-500" },
                { name: "Syntactic", passed: 245, total: 280, color: "bg-purple-500" },
                { name: "Context", passed: 156, total: 190, color: "bg-green-500" },
                { name: "Multi-Turn", passed: 189, total: 220, color: "bg-orange-500" },
                { name: "Adversarial Examples", passed: 166, total: 199, color: "bg-red-500" },
              ].map((category) => {
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid gap-4 md:grid-cols-4">
                {[
                  { label: "Toxicity", count: 28, percentage: 2.6, color: "text-red-500" },
                  { label: "PII", count: 15, percentage: 1.4, color: "text-orange-500" },
                  { label: "Bias", count: 42, percentage: 3.9, color: "text-yellow-500" },
                  { label: "Behavior", count: 27, percentage: 2.5, color: "text-blue-500" },
                ].map((flag) => (
