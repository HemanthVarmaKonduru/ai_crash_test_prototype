#!/usr/bin/env python3
"""
Simple API Server for Prompt Injection Testing
"""
...
from backend.config.settings import (
    API_KEY, TARGET_MODEL, JUDGE_MODEL, MAX_PROMPTS_PI, CORS_ORIGINS
)
MAX_PROMPTS = MAX_PROMPTS_PI  # Alias for backward compatibility

# Global storage for test sessions
test_sessions: Dict[str, Dict[str, Any]] = {}

app = FastAPI(
    title="Prompt Injection Testing API",
    description="API for comprehensive prompt injection testing",
    version="1.0.0"
)
...
async def health_check():
    return {"status": "healthy", "service": "prompt-injection-api"}
